#ifndef _MSTAR_MD5_H_
#define _MSTAR_MD5_H_

#include<stdio.h>

#ifndef md5_print
#define md5_print //ui_print
#else
#undef md5_print
#define md5_print //ui_print
#endif
...
int mstar_md5sum(char* file_name, char* md5_val) {
    md5_print("[%s: %d] file_name=\"%s\"\n",__func__,__LINE__,file_name);
    ...
    sprintf(md5_val,"%08x%08x%08x%08x", PP(A),PP(B),PP(C),PP(D));
    md5_print("MD5 Code:%08x%08x%08x%08x\n",PP(A),PP(B),PP(C),PP(D));
