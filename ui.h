...
class RecoveryUI {
  public:
    ...
    enum Tip {
        TIP_TITLE_NONE,
        TIP_TITLE_READY,
        TIP_TITLE_INSTALL_PACKAGE,
        TIP_TITLE_WIPE_DATA,
        TIP_TITLE_WIPE_CACHE,
        TIP_TITLE_SUCCESS,
        TIP_TITLE_ERROR,
        TIP_TITLE_BACKUP_SYSTEM,
        TIP_TITLE_RESTORE_SYSTEM,
        TIP_TITLE_BLANK_SCREEN,
        NUM_TIP_TITLES
    };
    virtual void SetTipTitle(Tip tip)=0;
    virtual void SetExitRecoveryTipTitle(int exitRecoveryTip) = 0;
