...
LOCAL_MODULE := libfbdev_recovery
LOCAL_MODULE_TAGS := optional

LOCAL_SRC_FILES := fbdev_recovery.c
...
ifeq ($(TARGET_BOARD_PLATFORM),monaco)
    LOCAL_CFLAGS += -DENABLE_CMD_QUEUE
endif
ifeq ($(BUILD_FOR_STB),true)
    LOCAL_CFLAGS += -DBUILD_FOR_STB
ifeq ($(TARGET_BOARD_PLATFORM),monaco)
    LOCAL_CFLAGS += -DFORCE_DISPLAY_FHD
endif
endif
ifeq ($(ENABLE_HWCURSOR),true)
    LOCAL_CFLAGS += -DENABLE_HWCURSOR
endif
ifeq ($(ENABLE_4K2K_OP_DEFAULT),true)
    LOCAL_CFLAGS += -DENABLE_4K2K_OP_DEFAULT
endif
